type EAWType = "F" | "H" | "W" | "Na" | "A" | "N";
type CharLength = 1 | 2;

export function eastAsianWidth(character: string): EAWType {
...
export function characterLength(character: string): CharLength {
  const code: EAWType = eastAsianWidth(character);
